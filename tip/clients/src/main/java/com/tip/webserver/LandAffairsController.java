package com.tip.webserver;

import com.google.gson.Gson;
import com.google.gson.GsonBuilder;
import com.tip.flows.land.RegisterLandFlow;
import com.tip.states.Coordinates;
import com.tip.states.LandState;
import com.tip.webserver.util.FlowResult;
import com.tip.webserver.util.PingResult;
...
public class LandAffairsController {
    ...
    private String startRegisterLandFlow() throws ExecutionException, InterruptedException {
        ...
        try {
            ...
            polygon.add(new Coordinates(-25.21098, 27.2879));
            polygon.add(new Coordinates(-25.22525, 27.2935));
            polygon.add(new Coordinates(-25.23765, 27.3005));

            CordaFuture<SignedTransaction> signedTransactionCordaFuture = proxy.startTrackedFlowDynamic(
                    RegisterLandFlow.class, "Erf " + System.currentTimeMillis(),
                    landAffairsParty, bnoParty, regulatorParty, polygon, new Date(), "Piece of Land: "
                            + new Date().toString(),
                    amount).getReturnValue();
