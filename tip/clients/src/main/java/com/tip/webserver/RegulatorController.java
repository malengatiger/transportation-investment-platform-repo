 ...
 */
@RestController
@RequestMapping("/regulator") // The paths for HTTP requests are relative to this base path.
public class RegulatorController {
    private final CordaRPCOps proxy;
    private final static Logger logger = LoggerFactory.getLogger(RegulatorController.class);
    private static final Gson GSON = new GsonBuilder().setPrettyPrinting().create();

    public RegulatorController(NodeRPCConnection rpc) {
