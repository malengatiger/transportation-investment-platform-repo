...
@InitiatedBy(RegisterLandFlow.class)
public class RegisterLandFlowResponder extends FlowLogic<SignedTransaction> {
    private final static Logger logger = LoggerFactory.getLogger(RegisterLandFlowResponder.class);
