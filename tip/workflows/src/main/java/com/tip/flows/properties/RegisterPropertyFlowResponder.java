package com.tip.flows.properties;
...
@InitiatedBy(RegisterPropertyFlow.class)
public class RegisterPropertyFlowResponder extends FlowLogic<SignedTransaction> {
    private final static Logger logger = LoggerFactory.getLogger(RegisterPropertyFlowResponder.class);
    private final FlowSession counterPartySession;

    public RegisterPropertyFlowResponder(FlowSession counterPartySession) {
        this.counterPartySession = counterPartySession;
        logger.info("RegisterPropertyFlowResponder Constructor fired: \uD83C\uDF45 \uD83C\uDF45 \uD83C\uDF45");
    }
